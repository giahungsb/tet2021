function displayAll(){
    ...
    this.number2021 = document.getElementsByClassName("number"); // Các chữ số trong 2021
    this.textTet = document.getElementsByClassName("textTet")[0]; // Không biết gọi thế nào :)
    this.slogan = document.getElementsByClassName("slogan")[0]; // Câu nói hay ho năm Tân Sửu
    ...
    // Hiển thị các chữ số trong 2021
    this.displayNumber2021 = function() {
        this.display(1200, 200, 2, this.number2021, "top", -8, "%");
    }
    // Hiển thị câu slogan tết 2021
